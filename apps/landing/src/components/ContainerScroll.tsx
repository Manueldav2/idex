...
const Card = ({
  ...
  <motion.div
    ...
    className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border border-line p-2 md:p-4 bg-ink-1 rounded-[24px] shadow-2xl"
  >
    <div className="h-full w-full overflow-hidden rounded-2xl bg-ink-0 md:rounded-2xl">
      {children}
    </div>
  </motion.div>
);
